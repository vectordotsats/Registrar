    ...
    const load = async () => {
      const [salesRes, itemsRes, debtorsRes] = await Promise.all([
        supabase
          .from("sales")
          .select(
            "id, sale_date, total_amount, amount_paid, payment_type, sold_by",
          )
          .eq("is_deleted", false)
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-4">
          <p className="text-xs text-gray-500 mb-1">Sales value</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-4">
          ...
          <p className="text-xs text-gray-400">{debtors.length} customers</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                {staffRanking.map((s, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">{s.count} sales</p>
                    </div>
                    <p className="text-sm font-semibold text-gray-900">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            {debtors.length === 0 ? (
              <p className="text-sm text-gray-400 text-center py-10">No debt</p>
            ) : (
              <div>
