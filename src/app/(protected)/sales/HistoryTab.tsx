        ...
        <div className="flex gap-2">
          {(["all", "cash", "invoice"] as const).map((type) => (
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${filter === type ? "bg-[var(--color-primary)] text-white" : "border border-gray-300 text-gray-600 hover:bg-gray-50"}`}
            >
            ...
            {filtered.map((sale) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isInvoice ? "bg-[var(--color-primary-light)]" : "bg-gray-100"}`}
                    >
                      {isInvoice ? (
                        <FileText
                          size={18}
